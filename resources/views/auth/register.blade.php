    ...
    <div class="row">
        ...
        <div class="col-md-8" id="main-container">
            ...
            <div class="panel panel-default">
                <div class="page-panel-title">@lang('Register') {{ucfirst(session('register_rolee'))}}</div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" id="registerForm" action="{{ url('register/'.session('register_role')) }}">
                        ...
                        @if(session('register_role', 'student') == 'student' || session('register_role', 'student_with_exist_parents') == 'student_with_exist_parents' )
                        ...
                        <div class="form-group{{ $errors->has('father_phone_number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="father_phone_number" type="text" class="form-control" name="father_phone_number" value="{{ old('father_phone_number') }}" require>
                        ...
                        <div class="form-group{{ $errors->has('father_national_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="father_national_id" type="text" class="form-control" name="father_national_id" value="{{ old('father_national_id') }}" require>
                        ...
                        @if(session('register_role', 'student') == 'student')
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">* @lang('Parents E-Mail Address')</label>

                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control" name="parents_email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label">* @lang('Parents Password')</label>

                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control" name="parents_password" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="father_password_confirmation" required>
                            </div>
                        </div>
                        @endif
