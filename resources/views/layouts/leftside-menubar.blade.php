...
<ul class="nav flex-column">
  ...
  <li class="nav-item">
    <a class="nav-link" href="{{url('users/parents-message')}}"><i class="material-icons">contacts</i>
  ...
  <li class="nav-item">
    <a class="nav-link" href="{{url('children/'.Auth::user()->id)}}"><i class="material-icons">contacts</i>
      <span class="nav-link-text">@lang('children')</span></a>
  </li>
  @endif
  @if(Auth::user()->role == 'admin')
  <li class="nav-item dropdown">
  ...
  @if(Auth::user()->role == 'parents')
  <li class="nav-item">
    <a class="nav-link" href="{{url('parents/'.Auth::user()->id.'/notifications')}}">
