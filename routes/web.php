...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('user/{user_code}', 'UserController@show')->name('user');
...
Route::middleware(['auth', 'admin'])->group(function () {
Route::get('notifications/{admin_id}/{parents_id}','ParentsnotifController@index');});
Route::get('k/{parents_id}','UserController@indexe');
Route::middleware(['auth', 'teacher'])->group(function () {
...
Route::get('parents/{id}/notifications','ParentsnotifController@show')->name('parents');;
Route::get('children/{id}','ChildrenController@index');
});
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('checkID', 'UserController@checkID');
    Route::get('preregister/student', 'UserController@choose');
    Route::get('preregister/parents-exist', 'UserController@selectID');
    Route::prefix('register')->name('register.')->group(function () {
        Route::post('student_with_exist_parents', 'UserController@store_student_with_exist_parents');
        Route::get('student', 'UserController@redirectToRegisterStudent');

        Route::post('parents', 'UserController@storeparent');
        Route::get('parents', 'UserController@redirectToRegisterParents');
...
Route::middleware(['auth', 'admin'])->group(function () {
Route::post('message/parents', 'ParentsnotifController@store');
Route::get('users/parents-message','UserController@parents_message');
